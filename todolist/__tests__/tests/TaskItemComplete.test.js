...
test('calls completeTask when check icon is pressed', () => {
  ...
  // Симулируем нажатие на кнопку завершения задачи
  fireEvent.press(getByTestId('complete-task-button'));
  // Проверяем, что функция completeTask была вызвана с правильным аргументом
